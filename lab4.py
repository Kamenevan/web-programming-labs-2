...
def grain():
     ...
     return render_template('grainorder.html',error=error, price=price, grain=grain, weight=weight, error1=error1)    

@lab4.route('/lab4/grainorder', methods= ['GET','POST'])
def grains():
     if request.method == 'GET':
         return render_template('grainorder.html')
